import { BarChartIcon, SketchLogoIcon } from "@radix-ui/react-icons"
  ...
  return (
    <>
      <div className="w-screen bg-blue-400">
        <div className="mx-auto max-w-5xl h-[400px] flex px-4 flex-col items-center gap-4 pt-16">
          <BarChartIcon color="white" height={100} width={100} />
          <span className="text-white drop-shadow-md text-6xl">
            Human Ranking
          </span>
          <span className="text-white drop-shadow-md text-xl">
            Measure Yourself Against the World
          </span>
      ...
      <div className="bg-slate-100 h-screen">
        <div className="max-w-7xl mx-auto pt-8 grid grid-cols-3 gap-8 bg-slate-100">
          <RankingCard title="Yearly Income Ranker" desc="See Where Your Earnings Stand Globally" content={
            <div
              className="flex justify-center"
            >
              <SketchLogoIcon height={60} width={60} />
            </div>
          } />
          <RankingCard title="Height Ranker" desc="Find Out How You Measure Up Internationally" content={
            <div
              className="flex justify-center"
            >
              <RulerIcon height={60} width={60} />
            </div>
          } />
